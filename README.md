...
Download and Install Maven 3.8 or higher locally and follow the below steps:
* Go to the right corner of the IDE and get inside the Maven option.
* Select the Maven Settings option and set the Maven Home Path to the path of the Maven 3.8 or higher installed locally.
...
Link:
[Charts](../../../ecsp-helm-charts/tree/main/device-auth)
